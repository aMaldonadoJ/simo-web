      ...
      <div className="flex items-center justify-center w-full h-screen">
        ...
        >
          ...
          >
            ...
            <div className="row-start-3 sm:row-start-2 md:row-start-1 md:col-start-6 lg:col-start-10 col-span-3 sm:place-self-end">
            ...
            <div className="row-start-4 sm:row-start-3 sm:col-span-2 lg:row-start-2 md:col-span-8 lg:col-span-12 relative z-0 flex items-center">
