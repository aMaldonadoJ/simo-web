      ...
      <div className="flex items-center justify-center w-full h-screen mt-40">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-custom-y md:gap-x-custom-x">
            ...
            <motion.div className="flex row-start-1 col-span-2 md:col-span-2 mb-4 mt-2"
            ...
            <div className="row-start-4 md:row-start-1 md:col-start-7 md:col-span-6 bg-slate-200 overflow-hidden relative h-[500px] md:h-[600px] sm:w-[700px] md:w-auto">
              <div className="relative w-[200%] h-full" style={{left: 'clamp(-245px, -5vw, -220px)',}}>
