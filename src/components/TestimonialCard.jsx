  ...
  return (
    <div className="grid grid-cols-1 grid-rows-3 grid-personalizada lg:grid-cols-7 gap-y-2 w-full ">
      ...
      <p className="text-gray-600 font-nunito text-lg "
        style={{ width: 'clamp(700px, 25vw, 600px)' }}>{testimonio}</p>
      </div>

      <img src={logo} alt={cliente} className="col-span-2 row-start-3 object-contain justify-self-start  mt-2 h-[100px]" 
