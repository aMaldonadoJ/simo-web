      ...
      >
        <div className="grid md:grid-cols-4 grid-cols-1 gap-6 w-full ss:pr-20 sm:pr-0">
          <div className="flex flex-col gap-8 col-span-3 justify-center">
            ...
            <motion.h1
              className="font-urbanist font-bold text-greenSimo100 text-[40px] leading-[2.5rem] ss:text-6xl ss:leading-[3.5rem] md:text-[clamp(3.75rem,5vw,5rem)] md:leading-[clamp(3.5rem,5vw,5rem)]"
              initial={{ opacity: 0, y: -60 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.3, duration: 1 }}
            >
            ...
            <motion.p
              className="font-nunito font-medium text-xl md:text-2xl text-white max-w-[800px] mt-1 ss:mt-5 leading-relaxed lg:leading-normal"
              initial={{ opacity: 0, y: -60 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.3, duration: 1 }}
            >
