...
const AcercaSimo = () => {
  ...
  return (
    <section id="acercasimo" ref={sectionRef} className="min-h-screen overflow-auto">

      <div className="flex items-center justify-center w-full h-full mt-20">
        {/* Container principal con max-width y padding responsivo */}
        <div
          className="max-w-[1920px] w-full h-screen overflow-auto relative"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-y-8 gap-8">
            ...
            {/* Párrafo */}
            <motion.div className="row-start-2 sm:col-span-2 md:col-start-3 md:col-span-4 mb-4 mt-2 "
              initial={{ opacity: 0, y: 50 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ delay: 0.3, duration: 1 }}>
              <p className="font-urbanist text-lg text-greenSimo200 tracking-wide font-normal text-[clamp(16px,2vw,18px)] md:leading-[clamp(28px,9px,24px)]">
            ...
            {/* Listas */}
            <div className="row-start-3 md:col-start-3 md:col-span-2">
              <div className="flex gap-12 sm:gap-20 md:gap-48 lg:gap-40">

                <div className="space-y-4">
                  <h4 className="font-urbanist font-medium text-lg mb-4 text-white">Simo</h4>
                  <ul className="font-nunito font-light text-lg text-greenSimo200">
                ...
                <div className="space-y-4">
                  <h4 className="font-urbanist font-medium text-lg mb-4 text-white">Estudios</h4>
                  <ul className="font-nunito font-light text-lg text-greenSimo200">
            ...
            {/* Servicios */}
            <div className="row-start-4 sm:row-start-3 sm:col-start-2 md:col-start-5 md:col-span-2 space-y-4">
              <h4 className="font-urbanist font-medium text-lg mb-4 text-white">Servicios</h4>
              <ul className="font-nunito font-light text-lg text-greenSimo200">
            ...
            {/* Dirección */}
            <div className="row-start-5 sm:col-span-2 md:row-start-4 md:col-start-3 md:col-span-3">
              <h4 className="font-urbanist font-medium text-lg mb-4 text-white">Contacto</h4>
              <p className="font-nunito font-light text-lg text-greenSimo200">
            ...
            {/* Divider */}
            <motion.div className="row-start-7 sm:col-span-2 md:row-start-5 md:col-start-1 md:col-span-6 bg-white h-[1px]"
            ...
            {/* Derechos */}
            <motion.div className="row-start-8 md:row-start-5 md:col-start-1 md:col-span-2"
              style={{ fontSize: 'clamp(.5rem, 1.25rem, 1.25rem)' }}
              initial={{ opacity: 0, y: 30 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ delay: 0.3, duration: 1 }}>
              <h1 className="font-urbanist text-white font-light tracking-wide text-base md:text-[clamp(1rem,80vw,1rem)] md:leading-[clamp(3.5rem,4vw,4.25rem)]">
