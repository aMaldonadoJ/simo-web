    ...
    return (
        ...
        <Swiper className='container md:w-full md:overflow-hidden lg:max-w-none'
            ...
            coverflowEffect={{
                ...
                modifier: 0,              // Modificador de la intensidad del efecto
