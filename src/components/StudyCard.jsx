...
const StudyCard = ({ title, date, image }) => {
    return (
        <div className="bg-white rounded-2xl  flex flex-col w-[450px] justify-between h-[550px] overflow-hidden cursor-pointer transition group"
            style={{ width: 'clamp(400px, 25vw, 400px)', height: 'clamp(475px, 30vw, 550px)' }}
